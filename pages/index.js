  ...
  useEffect(() => {
    ...
    return (
        <div>
            <Head>
                <title>alanajs</title>
                <meta name="description" content="AlanaJS" />
                ...
                <div class="w-full bg-center bg-cover h-full py-48">
                    ...
                    <div class="flex flex-col justify-center items-center">
                        ...
                        <div id='title' class="text-center">
                            <h1 id='title' class= "text-5xl font-semibold text-black lg:text-6xl px-5">alanajs</h1>
            ...
            <div class="max-w-7xl px-5 py-16 mx-auto">
                    <div class="items-center md:flex md:space-x-6 py-28">                        
                        ...
                        <div class="md:w-1/2 text-justify"> 
                            <h3 class="text-3xl font-semibold leading-10 lg:leading-10 text-gray-700">alanajs is an all-in-one tool that simplifies AWS SDK from development to production</h3>
                            <p class="text-xl leading-10 tracking-normal lg:leading-9 mt-4 text-gray-600">Make setting up Lambda microservices easier than ever. Designed specifically for the Node.js runtime environment, alanajs consolidates functionality provided by AWS SDK and AWS CLI, automating your deployment and configuration tasks so that you could focus on writing code. </p>
                        </div>                        
                    </div>
                </div>
            </section>
                ...
                <div class="max-w-7xl px-3 py-16 mx-auto">
                    <div class="items-center md:flex md:space-x-6 py-28">
                        <div class="md:w-1/2 text-justify"> 
                            ...
                            <p class="text-xl leading-10 lg:leading-9 mt-4 text-gray-600">alanajs provides two ways of interacting with the Amazon SDK with just one npm install. Import functions from the npm package to use within your application logic, or use the Alanajs CLI to test and deploy functions and APIs with a easy-to-use interface. </p>
                        </div>            

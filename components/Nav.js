            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                <div class="flex items-top justify-between">
                    ...
                    <div class="flex flex-col lg:hidden">
                        ...
                        {menuShow ? 
                            <div class="flex flex-col sticky top-0 left-0 bg-gray-800 dark:bg-gray-800">
                                <Link href="/documentation"><a class="text-right mx-4 mt-1 text-xl text-gray-200 capitalize lg:mt-0 hover:text-gray-400 font-semibold">Documentation</a></Link>
                                <Link href="/tutorial"><a class="text-right mx-4 mt-1 text-xl text-gray-200 capitalize lg:mt-0 hover:text-gray-400 font-semibold">Tutorial</a></Link>
                                <Link href="/contact"><a class="text-right mx-4 mt-1 text-xl text-gray-200 lg:mt-0 hover:text-gray-400 font-semibold">Contact</a></Link>
                                <Link href="https://github.com/oslabs-beta/Alana.js"><a target="_blank" class="text-right mx-4 mt-1 text-xl text-gray-200 capitalize lg:mt-0 dark:text-gray-200 hover:text-gray-400 ">Github</a></Link>
                            </div> : null}
                        </div>
                    </div>
                    <div class="hidden -mx-4 lg:inline-flex lg:items-center">
                        ...
                        <Link href="/contact"><a class="block mx-4 mt-2 text-xl text-gray-200 lg:mt-0 dark:text-gray-200 hover:text-gray-400 font-semibold">Contact</a></Link>

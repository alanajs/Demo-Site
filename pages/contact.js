...
function Contact() {
    ...
    <div>
       <Head>
        ...
        <main>
          <form id="contact-me" class="w-full mx-auto max-w-2xl bg-white shadow-inner p-8 py-10 text-orange-500 justify-center">     
            <h1 class="w-full my-2 text-3xl font-bold leading-tight my-5 text-center">Contact Form</h1>     
            ...
            <div class="flex flex-wrap mb-6">
              <div class="w-full px-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="email" type="email" placeholder="abcd@gmail.com"/>
              </div>
            </div>
            <div class="flex flex-wrap mb-6">
              <div class="w-full px-3">

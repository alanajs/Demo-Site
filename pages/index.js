            ...
            <div class="max-w-7xl px-5 py-16 mx-auto">
                    <div class="items-center md:flex md:space-x-6 py-28">                        
                        ...
                        <div class="md:w-1/2"> 
                            ...
                            <p class="text-xl leading-10 tracking-normal lg:leading-9 mt-4 pt-2 text-gray-600"> Designed specifically for the Node.js runtime environment, alanajs consolidates functionality provided by AWS SDK and AWS CLI, automating your deployment and configuration tasks so that you can focus on writing code. </p>
                        </div>                        
                    </div>
                </div>
            </section>

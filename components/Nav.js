                ...
                <div class="flex items-top justify-between">
                    ...
                    <div class="flex flex-col lg:hidden">
                        ...
                        {menuShow ? 
                            ...
                            {/* <Link href="/"><a class="text-right mx-4 mt-2 text-med text-gray-200 capitalize lg:mt-0 dark:text-green-200 hover:text-gray-400 ">Home</a></Link> */}
                            ...
                            <Link href="https://github.com/oslabs-beta/Alana.js"><a class="text-right mx-4 mt-1 text-med text-gray-200 capitalize lg:mt-0 dark:text-gray-200 hover:text-gray-400 ">Github</a></Link></div> : null}
                    </div>
                </div>

                <div class="hidden -mx-4 lg:flex lg:items-center">
                    {/* <Link href="/"><a class="block mx-4 mt-2 text-med text-gray-200 capitalize lg:mt-0 dark:text-gray-200 hover:text-gray-400 ">Home</a></Link> */}
